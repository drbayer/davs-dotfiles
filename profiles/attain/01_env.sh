...
# AWS RDS Hosts
export devstats=devstats.cv9fmu9rjt22.us-east-2.rds.amazonaws.com
...
export kloverstats_rr=kloverstats-readreplica.c6zdrrll14uj.us-east-2.rds.amazonaws.com
export aurora_prod=klover-axis-production.cluster-c6zdrrll14uj.us-east-2.rds.amazonaws.com
export PATH=$PATH:/opt/attain/bin:/opt/homebrew/opt/mysql-client/bin:$HOME/repos/tools/sre-scripts
